...
Vanochtend ben ik begonnen met het invullen van portflow, vandaag 4.3.3. Na dit afgemaakt te hebben heb ik samen met Tom nog de feedback van de presentatie van vorige week vrijdag verwerkt in ons Linear projectboard. 
Vervolgens heb ik gelijk een retrospective ingepland met Tom, Chris en Anne om te reflecteren op onze werkwijze en samenwerking om te zien of er nog verbeterpunten zijn voor volgende blok.

Hierna ben ik verder gegaan met issue CGC-20 en heb ik de feedback die ik op de PR had gekregen verwerkt.

Verder heb ik vooral aan Teamkeys gewerkt: Ik heb kleur variabelen toegevoegd in de `colors.scss`, en ben verder gegaan met het bouwen van de platte HTML en SCSS voor de login UI.
